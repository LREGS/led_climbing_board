...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label.setGeometry(QRect(10, 0, 400, 400))
        self.label.setMaximumSize(QSize(400, 400))
        self.label.setPixmap(QPixmap(u"../board400x400.png"))
        self.label.setScaledContents(True)
        self.label_3 = clickableLabel(Form)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(330, 40, 21, 16))
        self.label_3.setPixmap(QPixmap(u"../TESThold11.png"))
        self.label_3.setScaledContents(True)
        self.label_2 = clickableLabel(Form)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(320, 220, 31, 16))
        self.label_2.setPixmap(QPixmap(u"../holdPhotos/output/hold54.png"))
